...
class MY_Model extends CI_Model
{
    ...
    protected $_created_by_field = 'created_by';
    protected $_updated_by_field = 'updated_by';
    protected $_deleted_by_field = 'deleted_by';
    ...
    {
    	//$data[$this->_created_by_field] = $_SESSION['user_id'];
        $data[$this->_created_by_field] = "Uki";
    	return $data;
    }

    public function add_updater($data)
    {
	    //$data[$this->_updated_by_field] = $_SESSION['user_id'];
        $data[$this->_updated_by_field] = "Uki";
	    return $data;
    }
}
